...
{
    public static Option<T, Q> Create<T, Q>(string title, IEnhancedCommandOf<T, Q> command, bool isDefault = false, bool isCancel = false)
    {
        return new Option<T, Q>(title, command, isDefault, isCancel);
    }
    
    public static Option<Unit, Unit> Create<T, Q>(string title, IEnhancedCommandOf<Unit, Unit> command, bool isDefault = false, bool isCancel = false)
    {
