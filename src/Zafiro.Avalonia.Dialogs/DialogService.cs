...
{
    [PublicAPI]
    public static ISimpleDialog Create(IApplicationLifetime lifetime, Maybe<Action<ConfigureWindowContext>> configureWindow)
    {
        return lifetime switch
        {
            IClassicDesktopStyleApplicationLifetime => new SimpleDesktopDialogService(configureWindow),
