...
public class WizardDesign : IWizard
{
    ...
    public IEnhancedUnitCommand BackCommand { get; } = EnhancedCommand.Enhance(ReactiveCommand.Create(() => { }));
    public IEnhancedCommand<Result<object>> NextCommand { get; } = EnhancedCommand.Enhance(ReactiveCommand.Create(() => Result.Success<object>(123)));
